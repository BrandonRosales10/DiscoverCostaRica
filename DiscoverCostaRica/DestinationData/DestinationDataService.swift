...
class DestinationDataService {
    ...
    Destination(
                ...
                hoursOfOperation: "Opened daily from 8am to 4pm",
    ...
    Destination(
               ...
               hoursOfOperation: "Open daily from 7 am to 4 pm",
    ...
    Destination(
                ...
                hoursOfOperation: "Open daily from 8am to 4pm",
    ...
    Destination(
                ...
                hoursOfOperation: "Opened daily from 8am to 3:30pm",
    ...
    Destination(
               ...
               hoursOfOperation: "Opened from May to November, every day from 8am to 4pm. From December to April, daily from 7 am to 4 pm. ",
               activityType: ["Hiking"],
